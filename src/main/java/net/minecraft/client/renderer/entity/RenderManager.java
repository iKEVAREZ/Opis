...
public class RenderManager
{
    ...
    {
    	ProfilerSection.RENDER_ENTITY.start(p_147936_1_);        
        ...
        boolean retVal =  this.func_147939_a(p_147936_1_, d0 - renderPosX, d1 - renderPosY, d2 - renderPosZ, f1, p_147936_2_, p_147936_3_);
        
        ProfilerSection.RENDER_ENTITY.stop(p_147936_1_);
        return retVal;
    }
