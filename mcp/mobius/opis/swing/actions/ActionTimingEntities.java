...
public class ActionTimingEntities implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		PanelTimingEntities panel = (PanelTimingEntities)TabPanelRegistrar.INSTANCE.getTab("opis.timingents");
		...
		StatsEntity data        = (StatsEntity)table.getTableData().get(indexData);
