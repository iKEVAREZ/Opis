...
public enum Message {
	...
	LIST_PACKETS_OUTBOUND    (EnumSet.of(SelectedTab.PACKETS)),
	LIST_PACKETS_INBOUND     (EnumSet.of(SelectedTab.PACKETS)),
	LIST_PACKETS_OUTBOUND_250(EnumSet.of(SelectedTab.PACKETS)),
	LIST_PACKETS_INBOUND_250 (EnumSet.of(SelectedTab.PACKETS)),
